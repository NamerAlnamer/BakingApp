package com.example.android.bakingapp.detail;
...
public class DetailActivity extends AppCompatActivity {
    ...
    //Getting the instance of View Model for This activity DetailActivityViewModel
    private DetailActivityViewModel mDetailActivityViewModel = ViewModelProviders.of(this).get(DetailActivityViewModel.class);
